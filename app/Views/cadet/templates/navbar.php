        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="<?=site_url('cadet/profile')?>" class="dropdown-item">My Profile</a>
                    <a href="<?=site_url('cadet/account-security')?>" class="dropdown-item">Account Security</a>
                    ...
                    <div class="col">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item <?= ($title == 'Dashboard') ? 'active' : '' ?>">
                                <a class="nav-link" href="<?=site_url('cadet/dashboard')?>">
