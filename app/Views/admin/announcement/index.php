                ...
                <div class="container-xl">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-auto ms-auto d-print-none">
                            <div class="btn-list">
                                <a href="<?=site_url('announcement/create')?>"
                        ...
                        <div class="col-lg-12">
                            <div class="row g-3">
                                ...
                                <div class="empty">
                                    ...
                                    <p class="empty-title">
                                        Oops... looks like there are no announcement posted right now!
                                    </p>
                                ...
                                <div class="col-lg-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <small><?=substr($row['details'],0,200)?></small>
                                            <p><small>Date Posted : <?=$row['created_at']?></small></p>
                                        </div>
                                        <div class="d-flex">
